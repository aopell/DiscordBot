...
namespace DiscordBotNew.Commands
{
    public static class GeneralCommands
    {
        ...
        public static ICommandResult Decide(ICommandContext context, string option1 = "Yes", string option2 = "No", [JoinRemainingParameters, HelpText("Additional space-separated options")] string[] otherOptions = null) => new SuccessResult((otherOptions ?? new string[0]).Append(option1).Append(option2).OrderBy(x=>random.Next()).First());
